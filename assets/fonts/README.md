...
The laboratory site offers the same two reading-type combinations as the CPEN 221
readings site:
...
source URL. To update the asset set, use `scripts/vendor_google_fonts.py` in the
CPEN 221 textbook repository, review its output, and then copy the reviewed files
into this directory.
